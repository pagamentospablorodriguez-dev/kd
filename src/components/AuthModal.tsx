        ...
        if (!existing) {
          const { error: insertError } = await supabase
            ...
            .insert({
              ...
              name: formData.name || authUser.user_metadata?.name || authUser.user_metadata?.full_name || '',
              language: 'pt-BR',
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-3 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors disabled:opacity-50 flex items-center justify-center gap-3"
              >
